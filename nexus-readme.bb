Toggle Sprint lets you keep sprinting without holding down the Dash key as long as you're holding a movement key.

[size=4][b]Installation[/b][/size]

This mod requires [url=https://nexusmods.com/hollowknightsilksong/mods/26]BepInEx 5[/url], and is installed to your [font=Courier New][b]BepInEx/plugins[/b][/font] directory. Configuration Manager can be used with this mod.
